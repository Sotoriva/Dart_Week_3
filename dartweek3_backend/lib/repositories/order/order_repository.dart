...
import 'package:dartweek3_backend/entities/menu_item.dart';
import 'package:dartweek3_backend/entities/order.dart';
import 'package:dartweek3_backend/entities/order_item.dart';
...
class OrderRepository implements IOrderRepository {
  ...
  Future<List<Order>> findOrder(int userId) async {
    ...
    try {
      final ordersResult =
          await conn.query(''' SELECT * FROM pedido WHERE id_usuario = ? ''', [userId]);
